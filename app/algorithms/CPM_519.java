...
public class CPM_519 {
  ...
  public static void main(String[] args) {
    ...
    Task A = new Task("A", 0);
    Task B = new Task("B", 1, A);
    Task C = new Task("C", 2, A, B);
    Task D = new Task("D", 4, B, C);
    Task E = new Task("E", 3, C, D);
    Task F = new Task("F", 1 ,D, E);
    Task G = new Task("G", 8, E, F);
    Task H = new Task("H", 3, F, G);
    Task I = new Task("I", 2, G, H);
    Task J = new Task("J", 1, H, I);
